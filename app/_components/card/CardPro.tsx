        ...
        <div className="flex flex-col md:flex-row  gap-10 mt-10 justify-center items-center w-full p-5 ">
            ...
            <Card className="relative mx-auto  max-w-sm  dark:bg-purple-50 bg-body pt-0 overflow-hidden hover:scale-105 transition duration-300">
                ...
                <CardFooter className="flex flex-row justify-between  ">
                    <Link rel="stylesheet" href="https://github.com/riham8899/testrepo" className="flex flex-row gap-1 ">  <FaGithub className="text-2xl hover:text-3xl hover:scale-110 duration-500 transition-all text-black " /></Link>


                    <Link rel="stylesheet" href="https://testrepo-phi-liard.vercel.app/" className="flex items-center gap-1 text-ms hover:text-md hover:scale-110 duration-500 transition-all text-black "> live Demo <FaLocationArrow className="text-sm text-black" /> </Link>
                </CardFooter>
            </Card>
